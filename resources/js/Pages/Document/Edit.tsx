...
export default function EditDocument({ auth }: Props) {
    const [pending, setPending] = useState(false);
    const { categories } =
        usePage<PageProps<{ categories: Category[] }>>().props;
    const { document } = usePage<PageProps<{ document: Document }>>().props;
    ...
    const handleUpdate = () => {
        ...
        router.post(route("documents.update", document.id), payload, {
            forceFormData: true,
            onSuccess: () => {
                setFormData({
